"""
This is the main file to be run on the cluster, optimizes with ADAM.
...
filename = "cluster_" + function_name + '_' + str(seed) + '_' + str(dim_w) + '_' + str(iterations) + '_' + filename + '_adam'

full_loop(function_name, seed, dim_w, filename, iterations, ADAM=True)
