...
dim_w = 1
iterations = 50
num_w = 6  # number of w to draw to evaluate the true values, linspace if dim_w == 1, rand otherwise
num_x = 100000  # number of x used to evaluate the true values
alpha = 0.66  # risk level
eval_seed = 0  # seed used during final evaluations for both function eval and w generation if random
CVaR = False
# TODO: ackley output doesn't make sense
