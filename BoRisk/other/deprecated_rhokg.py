"""
This for storing deprecated code from rhoKG such as one-shot implementation
"""
from abc import ABC
...
class OldInnerRho(MCAcquisitionFunction):
    r"""
    This is a copy of InnerRho with lookahead still implemented.
    ...
    def old__init__(self, model: Model, w_samples: Tensor,
        ...
        :param CVaR: If true, uses CVaR. Think CVaR-KG. Default is VaR.
...
class OneShotrhoKG(AbsKG):
    ...
    def forward(self, X: Tensor) -> Tensor:
        ...
        for i in range(num_batches):
            ...
            values[left_index: right_index] = self.current_best_rho - inner_values.permute(1, 0)
        return values
