...
class DeprOptimizer(Optimizer):
    ...
    def optimize_OSrhoKG(self, acqf: OneShotrhoKG) -> Tuple[Tensor, Tensor]:
        """
        Optimizes OneShotrhoKG in a smart way.
        ...
        this.
        :param acqf: OneShotrhoKG object to be optimized
    ...
    def generate_simple_OSrhoKG_restart_points(self, acqf: OneShotrhoKG) -> Tensor:
        """
        Generates the restarts points for simple one-shot rhoKG
    ...
    def simple_optimize_OSrhoKG(self, acqf: OneShotrhoKG) -> Tuple[Tensor, Tensor]:
        """
        Optimizes the one-shot rhoKG in a pretty naive way.
        :param acqf: the rhoKG object
        :return: Optimal solution and value
        """
    ...
    def add_outer_solutions(self, solutions: Tensor, values: Tensor):
        """
        Adds the outer solutions of rhoKG
        :param solutions: Solutions
        :param values: Corresponding values
        :return: None
        """
