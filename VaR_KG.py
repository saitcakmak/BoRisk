    ...
    def forward(self, X: Tensor) -> Tensor:
        ...
        if X.dim() <= 4:
            if len(self.batch_shape) == 0:
                ...
                # Is this still the case? Or does the latest modifications allow for general shapes?
        ...
        # If non-uniform weights are given for w_samples, then take those into account while calculating C/VaR
